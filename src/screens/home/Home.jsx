...
const Home = () => {
    ...
    <nav className="">
      <div className="flow-root py-5">
        <div className="pl-4 float-left">
            <a className="font-bold text-2xl lg:text-xl" href="/">
                SEK. REN. ISLAM AL-HASANIAH
            </a>
    ...
    <div className="py-20 bg-gradient-to-r from-sky-300 via-blue-300 to-indigo-300">
      <div className="container mx-auto px-6">
        <h2 className="text-4xl font-bold mb-2 text-white">
            Sekolah Rendah Islam Al-Hasaniah
        </h2>
        <h3 className="text-2xl mb-8 text-gray-500">
            Jalan Cenderawasih 6/7, Seksyen 6, 40000 Shah Alam, Selangor
        </h3>
